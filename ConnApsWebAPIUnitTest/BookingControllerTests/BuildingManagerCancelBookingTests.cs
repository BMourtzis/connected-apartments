...
namespace ConnApsWebAPIUnitTest.WebAPI.BookingControllerTests
{
    public class BuildingManagerCancelBookingTests
    {
        ...
        public BuildingManagerCancelBookingTests()
        {
            ...
            model = new BmBookingCancelModel() { BookingId = 3, FacilityId = 5};
        ...
        public void CreateBooking_RegularValues_OkResult()
        {
            ...
            facade.Setup(f => f.CancelBooking("3445",model.FacilityId, model.BookingId));
